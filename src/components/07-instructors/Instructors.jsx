  ...
  return (
    <section id="instructors" className="p-5 bg-dark">
      <div className="container">
        <h2 className="text-white text-center">Our instructors</h2>
        <p className="lead text-white text-center">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe
          necessitatibus quaerat dolore quis praesentium unde reiciendis commodi
          pariatur debitis modi!
        </p>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="card bg-light">
              <div className="card-body text-center">
                ...
                />
                <h3 className="card-title mb-3">Lizeth</h3>
            ...
            <div className="card bg-light">
              <div className="card-body text-center">
                <img
                  ...
                  className="rounded-circle border border-3 border-dark mb-3 img-fluid"
                />
                <h3 className="card-title mb-3">Santiago</h3>
                <p className="card-text lead">
